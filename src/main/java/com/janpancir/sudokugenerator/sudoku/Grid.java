 ...
 */
package com.janpancir.sudokugenerator.sudoku;
...
public class Grid {
    ...
    /**
     * A static factory method which returns a Grid of a given two-dimensional
     * array of integers.
     *
    ...
    /**
     * Returns the size of this Grid. This method is useful if you want to
     * iterate over all {@link
     * Cell}s. <br><br> To access one cell use {@link #getCell(int, int)}.
     * <br><br> Note: This is the size of one dimension. This Grid contains size
     * x size {@link Cell}s.
     *
    ...
    /**
     * Returns the {@link Cell} at the given position within the Grid. <br><br>
    ...
    /**
     * Checks if a given value is valid for a certain {@link Cell}. <br><br> A
     * value is valid if it does not already exist in the same row, column and
     * box.
     *
    ...
    /**
     * Returns the first empty {@link Cell} of this Grid. <br><br> Note: The
     * result is wrapped by an {@link Optional}.
     *
     * @return a non-null value containing the first empty {@link Cell} if
     * present
     */
    ...
    /**
     * Returns the next empty {@link Cell} consecutively to the given
     * {@link Cell} in this Grid.
     * <br><br> Note: The result is wrapped by an {@link Optional}.
     *
     * @param cell the {@link Cell} of which the next empty {@link Cell} should
     * be obtained
     * @return a non-null value containing the next empty {@link Cell} if
     * present
     */
    ...
    /**
     * This class represents a Cell within a Sudoku {@link Grid}. <br><br> It
     * features a couple of convenient methods.
     */
    public static class Cell {
        ...
        /**
         * Returns the value of the Cell. <br><br> The value is a digit (1, ...,
         * 9) or 0 if the Cell is empty.
         *
        ...
        /**
         * Returns a {@link Collection} of all other Cells in the same row than
         * this Cell.
         *
        ...
        /**
         * Allows to set a {@link Collection} of Cells, which are interpreted to
         * be in the same row.
         *
        ...
        /**
         * Returns a {@link Collection} of all other Cells in the same column
         * than this Cell.
         *
        ...
        /**
         * Returns a {@link Collection} of all other Cells in the same box than
         * this Cell.
         *
        ...
        /**
         * Returns the next Cell consecutive to this Cell. <br><br> This
         * function returns the Cell to the right of each Cell if the Cell is
         * not the last Cell in a row. It returns the first Cell of the next row
         * of each Cell if the Cell is the last Cell in a row. For the very last
         * Cell in the very last row this function returns null.
         *
         * @return the next Cell consecutive to this Cell or null if it is the
         * last Cell.
         */
        ...
        /**
         * Allows to set a Cell which is interpreted to be the next Cell
         * consecutive to this Cell.
         *
